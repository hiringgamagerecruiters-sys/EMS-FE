...
const SubmitDiaries = () => {
 ...
 function combineDateTime(dateStr, timeStr) {
  ...
  return (
    <div className="bg-white p-4 max-w-8lg mx-auto rounded-lg shadow-sm">
      <h2 className="text-2xl font-bold text-gray-800 mb-2">
        Intern Daily Diaries (<span>{filteredDiaries.length}</span>)
      </h2>
      ...
      <div className="md:hidden grid grid-cols-1 sm:grid-cols-2 gap-4">
        {filteredDiaries.slice(0, visibleCards).map((diary, index) => (
          <div
            key={index}
      ...
      {visibleCards < filteredDiaries.length && (
