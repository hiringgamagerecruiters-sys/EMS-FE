  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex justify-center items-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto flex flex-col">
        ...
        <div className="p-6">
          <div className="flex flex-col md:flex-row gap-6 items-center md:items-start">
            ...
            <div className="relative -mt-20">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-4 border-white shadow-lg bg-amber-400 flex items-center justify-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
            {[
              ...
              { label: "Job Role", value: internData.userId?.jobRole?.jobRoleName },
              { label: "Team", value: internData.userId?.team?.teamName },
              { label: "Email", value: internData.userId.email },
              { label: "NIC", value: internData.userId.nic },
              { label: "Contact No", value: internData.userId.contactNumber },
              {
                label: "Intern Start Date",
                value: new Date(internData.userId.internStartDate)
                  .toISOString()
                  .split("T")[0],
              },
              {
                label: "Intern End Date",
                value: new Date(internData.userId.internEndDate)
                  .toISOString()
                  .split("T")[0],
              },
            ].map((item, idx) => (
        ...
        {/* Footer */}
        <div className="px-6 py-4 bg-gray-100 border-t text-right">
          <button
            onClick={onClose}
